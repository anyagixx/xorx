Contributing to XORX Core
============================

The XORX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the XORX Core project, and is not to be
confused with overall XORX Network Protocol consensus changes.

Whether a pull request is merged into XORX Core rests with the project merge
...
Patches that change XORX consensus rules are considerably more involved than
...
Where a patch set proposes to change the XORX consensus, it must have been
...
The project leader is the release manager for each XORX Core release.
