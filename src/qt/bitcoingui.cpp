                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("XORX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a XORX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xorx: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXORX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About XORX Core"), this);
    aboutAction->setStatusTip(tr("Show information about XORX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for XORX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your XORX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified XORX addresses"));
    ...
    openAction->setStatusTip(tr("Open a XORX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the XORX Core help message to get a list with possible XORX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("XORX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XORX network", "", count));
}
...
{
    QString strTitle = tr("XORX Core"); // default title
...
/** Creates context menu, its actions, and xorxs up all the relevant signals for mouse events. */
