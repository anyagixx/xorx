                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received XORX from zXORX"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zXORX"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zXORX));
