...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XORX features */
        {"xorx", "masternode", &masternode, true, true, false},
        {"xorx", "listmasternodes", &listmasternodes, true, true, false},
        {"xorx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"xorx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"xorx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"xorx", "masternodedebug", &masternodedebug, true, true, false},
        {"xorx", "startmasternode", &startmasternode, true, true, false},
        {"xorx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"xorx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"xorx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"xorx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"xorx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"xorx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"xorx", "mnbudget", &mnbudget, true, true, false},
        {"xorx", "preparebudget", &preparebudget, true, true, false},
        {"xorx", "submitbudget", &submitbudget, true, true, false},
        {"xorx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"xorx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"xorx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"xorx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"xorx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"xorx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"xorx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xorx", "checkbudgets", &checkbudgets, true, true, false},
        {"xorx", "mnsync", &mnsync, true, true, false},
        {"xorx", "spork", &spork, true, true, false},
        {"xorx", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"xorx", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use xorxd, or the -server option to xorx-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> xorx-cli " + methodname + " " + args + "\n";
}
