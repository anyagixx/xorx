...
In order to support loading of multiple wallets in xorx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xorx.cpp.
...
Changes to xorx.cpp
----------------------
xorx.cpp is the entry point into xorx-qt, and as such, will require some minor modifications to provide hooks for
