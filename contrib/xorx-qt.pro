...
RESOURCES += src/qt/xorx.qrc src/qt/xorx_locale.qrc

TRANSLATIONS += src/qt/locale/xorx_bg.ts \
                src/qt/locale/xorx_de.ts \
                src/qt/locale/xorx_en.ts \
                src/qt/locale/xorx_es.ts \
                src/qt/locale/xorx_fi.ts \
                src/qt/locale/xorx_fr.ts \
                src/qt/locale/xorx_it.ts \
                src/qt/locale/xorx_ja.ts \
                src/qt/locale/xorx_pl.ts \
                src/qt/locale/xorx_pt.ts \
                src/qt/locale/xorx_ru.ts \
                src/qt/locale/xorx_sk.ts \
                src/qt/locale/xorx_sv.ts \
                src/qt/locale/xorx_vi.ts \
                src/qt/locale/xorx_zh_CN.ts \
                src/qt/locale/xorx_zh_TW.ts
